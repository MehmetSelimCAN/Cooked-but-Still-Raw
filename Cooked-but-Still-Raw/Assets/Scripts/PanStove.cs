...
public class PanStove : Furniture {

    [SerializeField] private Transform fireGlowEffect;
    ...
    public void TurnOn() {
        fireGlowEffect.gameObject.SetActive(true);
    }

    public void TurnOff() {
        fireGlowEffect.gameObject.SetActive(false);
    }
}
